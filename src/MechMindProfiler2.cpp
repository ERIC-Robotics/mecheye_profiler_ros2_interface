...
sensor_msgs::msg::PointField createPointField2(const std::string& name, uint32_t offset,
...
void convertToROSMsg2(const mmind::eye::ProfileBatch& batch, float xResolution, float yResolution,
                     ...
                     sensor_msgs::msg::PointCloud2& texturedCloud)
{
    ...
    cloud.fields.push_back(createPointField2("x", 0, sensor_msgs::msg::PointField::FLOAT32, 1));
    cloud.fields.push_back(
        createPointField2("y", sizeof(float), sensor_msgs::msg::PointField::FLOAT32, 1));
    cloud.fields.push_back(
        createPointField2("z", sizeof(float) * 2, sensor_msgs::msg::PointField::FLOAT32, 1));

    texturedCloud.fields.reserve(4);
    texturedCloud.fields.push_back(
        createPointField2("x", 0, sensor_msgs::msg::PointField::FLOAT32, 1));
    texturedCloud.fields.push_back(
        createPointField2("y", sizeof(float), sensor_msgs::msg::PointField::FLOAT32, 1));
    texturedCloud.fields.push_back(
        createPointField2("z", sizeof(float) * 2, sensor_msgs::msg::PointField::FLOAT32, 1));
    texturedCloud.fields.push_back(
        createPointField2("intensity", sizeof(float) * 3, sensor_msgs::msg::PointField::UINT8, 1));
...
void callbackFunc2(const mmind::eye::ProfileBatch& batch, void* pUser)
{
    auto* mechMindProfiler = static_cast<mechmind2::MechMindProfiler2*>(pUser);
    if (mechMindProfiler)
...
MechMindProfiler2::MechMindProfiler2(const rclcpp::NodeOptions & options)
: rclcpp::Node("mechmind_profiler_publisher_service_2", options)
{
    declare_parameter<std::string>("profiler_ip", "192.168.0.38");
    ...
    pub_intensity =
        create_publisher<sensor_msgs::msg::Image>("/mechmind_profiler_2/intensity_image", 1);
    pub_depth = create_publisher<sensor_msgs::msg::Image>("/mechmind_profiler_2/depth_map", 1);
    pub_pcl =
        create_publisher<sensor_msgs::msg::PointCloud2>("/mechmind_profiler_2/point_cloud", 1);
    pub_textured_pcl = create_publisher<sensor_msgs::msg::PointCloud2>(
        "/mechmind_profiler_2/textured_point_cloud", 1);
    ...
    std::cout << "Profiler 2: Connected to the profiler successfully." << std::endl;

    mmind::eye::ProfilerInfo profilerInfo;
    showError(profiler.getProfilerInfo(profilerInfo));
    printProfilerInfo(profilerInfo);

    status = profiler.registerAcquisitionCallback(callbackFunc2, this);
    if (!status.isOK()) {
        throw status;
    }
    ...
    save_all_settings_to_user_sets_service =
        create_service<mecheye_profiler_ros_interface::srv::SaveAllSettingsToUserSets>(
            "save_all_settings_to_user_sets_2",
            std::bind(&MechMindProfiler2::save_all_settings_to_user_sets_callback, this,
                      std::placeholders::_1, std::placeholders::_2));

    set_current_user_set_service =
        create_service<mecheye_profiler_ros_interface::srv::SetCurrentUserSet>(
            "set_current_user_set_2", std::bind(&MechMindProfiler2::set_current_user_set_callback,
                                              this, std::placeholders::_1, std::placeholders::_2));

    set_int_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::SetIntParameter>(
            "set_int_parameter_2", std::bind(&MechMindProfiler2::set_int_parameter_callback, this,
                                           std::placeholders::_1, std::placeholders::_2));

    get_int_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::GetIntParameter>(
            "get_int_parameter_2", std::bind(&MechMindProfiler2::get_int_parameter_callback, this,
                                           std::placeholders::_1, std::placeholders::_2));

    set_float_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::SetFloatParameter>(
            "set_float_parameter_2", std::bind(&MechMindProfiler2::set_float_parameter_callback, this,
                                             std::placeholders::_1, std::placeholders::_2));

    get_float_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::GetFloatParameter>(
            "get_float_parameter_2", std::bind(&MechMindProfiler2::get_float_parameter_callback, this,
                                             std::placeholders::_1, std::placeholders::_2));

    set_bool_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::SetBoolParameter>(
            "set_bool_parameter_2", std::bind(&MechMindProfiler2::set_bool_parameter_callback, this,
                                            std::placeholders::_1, std::placeholders::_2));

    get_bool_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::GetBoolParameter>(
            "get_bool_parameter_2", std::bind(&MechMindProfiler2::get_bool_parameter_callback, this,
                                            std::placeholders::_1, std::placeholders::_2));

    set_enum_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::SetEnumParameter>(
            "set_enum_parameter_2", std::bind(&MechMindProfiler2::set_enum_parameter_callback, this,
                                            std::placeholders::_1, std::placeholders::_2));

    get_enum_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::GetEnumParameter>(
            "get_enum_parameter_2", std::bind(&MechMindProfiler2::get_enum_parameter_callback, this,
                                            std::placeholders::_1, std::placeholders::_2));

    set_profile_roi_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::SetProfileROIParameter>(
            "set_profile_roi_parameter_2",
            std::bind(&MechMindProfiler2::set_profile_roi_parameter_callback, this,
                      std::placeholders::_1, std::placeholders::_2));

    get_profile_roi_parameter_service =
        create_service<mecheye_profiler_ros_interface::srv::GetProfileROIParameter>(
            "get_profile_roi_parameter_2",
            std::bind(&MechMindProfiler2::get_profile_roi_parameter_callback, this,
                      std::placeholders::_1, std::placeholders::_2));
}

void MechMindProfiler2::handleCallbackBatch(const mmind::eye::ProfileBatch& batch)
{
...
void MechMindProfiler2::publishIntensityImage(
    mmind::eye::ProfileBatch::IntensityImage&& intensityImage)
{
    ...
    ros_image.header.frame_id = "mechmind_profiler_2/intensity_image";
    ros_image.header.stamp = this->now();
    pub_intensity->publish(ros_image);
    if (!save_file)
        return;
    if (cv::imwrite("/tmp/time.time_intensity_image_2.png", intensity))
        std::cout << "The intensity image is saved to /tmp" << std::endl;
    else
        std::cerr << "Failed to save the intensity image." << std::endl;
}

void MechMindProfiler2::publishDepthMap(mmind::eye::ProfileBatch::DepthMap&& depthMap)
{
    ...
    ros_depth.header.frame_id = "mechmind_profiler_2/depth_map";
    ros_depth.header.stamp = this->now();
    pub_depth->publish(ros_depth);
    if (!save_file)
        return;
    if (cv::imwrite("/tmp/depth_map_2.tiff", depth))
        std::cout << "The depth map is saved to /tmp." << std::endl;
    else
        std::cerr << "Failed to save the depth map." << std::endl;
}

void MechMindProfiler2::publishPointClouds(const mmind::eye::ProfileBatch& batch,
                                          const mmind::eye::UserSet& userSet)
{
    ...
    ros_cloud.header.frame_id = "mechmind_profiler_2/point_cloud";
    ros_cloud.header.stamp = this->now();
    sensor_msgs::msg::PointCloud2 ros_textured_cloud;
    ros_textured_cloud.header.frame_id = "mechmind_profiler_2/textured_point_cloud";
    ros_textured_cloud.header.stamp = this->now();
    convertToROSMsg2(batch, xResolution, yResolution, useEncoderValues, triggerInterval, ros_cloud,
                    ros_textured_cloud);
    pub_pcl->publish(ros_cloud);
    pub_textured_pcl->publish(ros_textured_cloud);
}

void MechMindProfiler2::start_acquisition_callback(
...
void MechMindProfiler2::stop_acquisition_callback(
...
void MechMindProfiler2::trigger_software_callback(
...
void MechMindProfiler2::profiler_info_callback(
...
void MechMindProfiler2::get_all_user_sets_callback(
...
void MechMindProfiler2::get_current_user_set_callback(
...
void MechMindProfiler2::set_current_user_set_callback(
...
void MechMindProfiler2::add_user_set_callback(
...
void MechMindProfiler2::delete_user_set_callback(
...
void MechMindProfiler2::save_all_settings_to_user_sets_callback(
...
void MechMindProfiler2::get_profile_roi_parameter_callback(
...
void MechMindProfiler2::set_profile_roi_parameter_callback(
...
void MechMindProfiler2::get_int_parameter_callback(
...
void MechMindProfiler2::set_int_parameter_callback(
...
void MechMindProfiler2::get_bool_parameter_callback(
...
void MechMindProfiler2::set_bool_parameter_callback(
...
void MechMindProfiler2::get_enum_parameter_callback(
...
void MechMindProfiler2::set_enum_parameter_callback(
...
void MechMindProfiler2::get_float_parameter_callback(
...
void MechMindProfiler2::set_float_parameter_callback(
...
RCLCPP_COMPONENTS_REGISTER_NODE(mechmind2::MechMindProfiler2)
